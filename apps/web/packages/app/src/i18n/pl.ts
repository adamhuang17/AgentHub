export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AgentHub",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AgentHub.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHub Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AgentHub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AgentHub.",
  ...
  "dialog.server.description": "Przełącz serwer AgentHub, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja AgentHub ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AgentHub",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AgentHub does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentHub zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the AgentHub server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AgentHub",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd AgentHub na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AgentHub ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AgentHub.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AgentHub",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AgentHub.",
