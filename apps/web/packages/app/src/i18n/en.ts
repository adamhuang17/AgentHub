export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models available in AgentHub",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AgentHub.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "AgentHub model access gives you a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "AgentHub settings",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AgentHub.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AgentHub.",
  ...
  "dialog.server.description": "Switch which AgentHub runtime server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "AgentHub runtime",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AgentHub runtime...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AgentHub runtime in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AgentHub runtime...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AgentHub runtime in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AgentHub runtime in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AgentHub runtime",
  "wsl.onboarding.opencodeReadyIn": "AgentHub runtime is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHub runtime is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AgentHub runtime in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AgentHub runtime",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AgentHub.",
  ...
  "toast.update.description": "A new version of AgentHub ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AgentHub team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, this AgentHub runtime does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentHub includes free models so you can start immediately.",
  ...
  "app.name.desktop": "AgentHub Desktop",
  ...
  "settings.desktop.wsl.description": "Run the AgentHub runtime inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AgentHub",
  ...
  "settings.general.row.appearance.description": "Customise how AgentHub looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AgentHub follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AgentHub is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AgentHub launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AgentHub.",
