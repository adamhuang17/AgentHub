...
export default function Layout(props: ParentProps) {
  ...
  const agentHubRoute = createMemo(() => location.pathname.startsWith("/agenthub"))
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("/agenthub")}
      renderPanel={() =>
  ...
  return (
    ...
    >
      <div class="relative flex h-dvh min-h-0 min-w-0 flex-col overflow-hidden bg-background-base text-text-base select-none [&_input]:select-text [&_textarea]:select-text [&_[contenteditable]]:select-text">
        {props.children}
        <ToastRegion v2={newDesign()} />
      </div>
    </Show>
